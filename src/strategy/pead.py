...
**2026-08-28: 네 번째까지 하고 닫았다.** 4차는 유휴 처리 변형이 아니라 밸류와
스코어 단계에서 합치는 것이었다(`src/strategy/composite.py`). 회전율은 5.58 → 3.38로
줄었지만 초과가 연 3.83%(t 1.14)로 **밸류 단독 4.73%보다 낮아** 사전 등록된 반증
확인 FC1에 걸렸다. 등록 문서에 "미달이면 닫는다, 5차는 없다"고 적었으므로 닫는다.

**여기에 다섯 번째를 붙이지 않는다.** 수치와 판단 근거는 experiments/log.md
2026-08-28 (5)(6)(8)에 있다.
